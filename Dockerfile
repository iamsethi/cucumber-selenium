...
ENTRYPOINT java -cp cucumber-selenium-docker.jar:cucumber-selenium-docker-tests.jar:libs/* -DHUB_HOST=$HUB_HOST -DBROWSER=$BROWSER $TEST" org.junit.runner.JUnitCore com.amazon.runner.RunnerTest